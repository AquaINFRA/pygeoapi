...
PROCESS_METADATA = {
    'version': '0.0.1',
    'id': 'get-upstream-polygons',
    'title': {'en': 'Return upstream catchment polygons as GeoJSON'},
    'description': {
        'en': 'Return the geometry of the upstream catchments'
              ' of the subcatchment into which the given point falls'
              ' as a GeoJSON Feature Collections (where the geometries are Polygons).'
